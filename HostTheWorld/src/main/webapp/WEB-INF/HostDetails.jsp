        ...
        <div class="row">
          ...
          <div class="col-md-4 me-5" style="color: white;">
          	...
          	<div style="overflow: auto; height: 200px;">
		         <c:forEach var="review" items="${host.hostReviews}"> 
					<h6>By <c:out value="${review.reviewer.name}"/> <span class="h6 ms-4">rate: <c:out value="${review.hostRank}"/></span>
						<span>
          ...
          <div class="col-md-3" style="color: white;">
            ...
            <div class="mt-4 d-flex">
				<button type="submit" class="btn btn-warning btn-sm">Add review</button>
