    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#d6a268;">
      ...
      <div class="container">
        <div class="row">
        	...
        	<h3 class="ms-5 my-3" style="color: darkorange;" >All hosts in  <c:out value="${search}" /></h3>
          ...
          <c:otherwise>
          	<h3 class="ms-5 my-3" style="color: darkorange;" >There is no host in this country yet!</h3>
          </c:otherwise>
          </c:choose>
        </div>
      </div>
