...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#d6a268;">
      ...
      <!-- body -->
      <h3 class="ms-5 my-3" style="color: darkorange;" >Welcome <c:out value="${currentUser.name}" /> <span class="ms-5"><a class="btn btn-sm btn-warning" href="/hostapartment/new"> Add Apartment</a></span> </h3>
      <section class="section1">
      <div class="container">
      	<h4 class="my-3" style="color: darkorange;">Hosts around the World:</h4>
        <div class="row">
