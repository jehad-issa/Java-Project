...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#d6a268;">
      ...
      <!-- body -->
      <h3 class="ms-5 my-3" style="color: darkorange;" >Welcome <c:out value="${currentUser.name}" /></h3>
      <section class="section1">
      <div class="container">
      	<h4 class="my-3" style="color: darkorange;">Your favorite hosts:</h4>
        <div class="row">
        	
        	<c:forEach var="host" items="${favorites}">
	          <div class="col">
